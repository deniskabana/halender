...
local M = {
  ...
  ["@function.call"]                       = { nocombine = true, fg = "yellow", italic = config.italic.functions },
  ...
  ["@variable.builtin"]                    = { fg = "purple", bold = true }, -- Variable names that are defined by the languages, like `this` or `self`.
  ...
  -- ["@lsp.mod.declaration"]               = { bold = true }, -- use treesitter styles for regular variables
  ...
  ["@lsp.typemod.class.defaultLibrary"]    = { fg = "purple", underline = false, bold = true, italic = false, nocombine = true },
  ...
  ["@lsp.mod.declaration"]                 = { fg = "fg", underline = false, italic = false, nocombine = true, bold = true },
